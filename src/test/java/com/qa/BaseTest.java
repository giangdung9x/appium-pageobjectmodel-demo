...
//	}
	...
	public BaseTest() {
		// Lấy đối tượng driver từ ThreadLocal
		AppiumDriver driverInstance = getDriver();
		if (driverInstance != null) {
			// Khởi tạo PageFactory với AppiumFieldDecorator
			PageFactory.initElements(new AppiumFieldDecorator(driverInstance), this);
		} else {
			// Xử lý nếu driverInstance là null
			System.out.println("Driver instance is null. Cannot initialize PageFactory.");
		}
	}
